Public Class Form19
    ...
    Private Sub Form19_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        abrir()
        conectarTabla(tablaDatos, "tipo_proteccion", "nombre")
    End Sub
    'boton atras
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        botonAgregar("tipo_proteccion", "nombre", "Proteccion")
        conectarTabla(tablaDatos, "tipo_proteccion", "nombre")
    End Sub
    ...
    Private Sub guardarCambios_Click(sender As Object, e As EventArgs) Handles guardarCambios.Click
        botonEditar(TextBox1, tablaDatos, campollave, "Proteccion", "tipo_proteccion", "nombre")
        conectarTabla(tablaDatos, "tipo_proteccion", "nombre")
    End Sub

    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        campollave = tablaDatos.CurrentRow.Cells.Item("nombre").Value.ToString()
        eliminare(tablaDatos, campollave, "Proteccion", "tipo_proteccion", "nombre")
        conectarTabla(tablaDatos, "tipo_proteccion", "nombre")
    End Sub
End Class
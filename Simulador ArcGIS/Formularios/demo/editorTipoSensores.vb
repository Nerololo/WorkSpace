Public Class Form18
    ...
    Private Sub Form18_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        abrir()
        conectarTabla(tablaDatos, "tipo_sensores", "nombre")
    End Sub
    'boton atras
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        botonAgregar("tipo_sensores", "nombre", "Sensores")
        conectarTabla(tablaDatos, "tipo_sensores", "nombre")
    End Sub
    ...
    Private Sub guardarCambios_Click(sender As Object, e As EventArgs) Handles guardarCambios.Click
        botonEditar(TextBox1, tablaDatos, campollave, "Sensores", "tipo_sensores", "nombre")
        conectarTabla(tablaDatos, "tipo_sensores", "nombre")
    End Sub
    'elimina un tipo de la tabla
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        campollave = tablaDatos.CurrentRow.Cells.Item("nombre").Value.ToString()
        eliminare(tablaDatos, campollave, "Sensores", "tipo_sensores", "nombre")
        conectarTabla(tablaDatos, "tipo_sensores", "nombre")
    End Sub
End Class
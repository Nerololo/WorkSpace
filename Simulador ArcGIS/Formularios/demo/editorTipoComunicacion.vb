Public Class editorTipoComunicacion
    'permite ver el formulario transparente
    Private Sub editorTipoComunicacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetStyle(ControlStyles.SupportsTransparentBackColor, True)
        Me.BackColor = Color.Transparent
        abrir()
        conectarTabla(tablaDatos, "tipo_comunicacion", "nombre")
    End Sub
    'boton atras
    ...
    Private Sub Agregar_Click(sender As Object, e As EventArgs) Handles Agregar.Click
        botonAgregar("tipo_comunicacion", "nombre", "Comunicacion")
        conectarTabla(tablaDatos, "tipo_comunicacion", "nombre")
    End Sub
    ...
    Private Sub guardarCambios_Click(sender As Object, e As EventArgs) Handles guardarCambios.Click
        botonEditar(TextBox1, tablaDatos, campollave, "Comunicacion", "tipo_comunicacion", "nombre")
        conectarTabla(tablaDatos, "tipo_comunicacion", "nombre")
    End Sub
    'elimina un tipo de la tabla
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        campollave = tablaDatos.CurrentRow.Cells.Item("nombre").Value.ToString()
        eliminare(tablaDatos, campollave, "Comunicacion", "tipo_comunicacion", "nombre")
        conectarTabla(tablaDatos, "tipo_comunicacion", "nombre")
    End Sub
End Class